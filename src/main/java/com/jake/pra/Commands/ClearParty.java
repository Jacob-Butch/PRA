...
public class ClearParty extends CommandBase implements ICommand {
    ...
    private void clearAll(PlayerPartyStorage pStorage){
        pStorage.set(0, (Pokemon)null);
        pStorage.set(1, (Pokemon)null);
        pStorage.set(2, (Pokemon)null);
        pStorage.set(3, (Pokemon)null);
        pStorage.set(4, (Pokemon)null);
        pStorage.set(5, (Pokemon)null);
    }
